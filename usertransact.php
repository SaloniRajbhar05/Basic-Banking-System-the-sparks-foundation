...
<ul id="navlist">
  ...
  <li class="navlist"><a href="index.php"><i  aria-hidden='true'></i>Home</a></li>
   ...
   <li class="navlist"><a class='active' href="transfer.php"><i  aria-hidden="true"></i> Payment Transfer</a></li>
    <li class="navlist"><a href="transactionhistory.php"><i  aria-hidden='true'></i>Transaction History</a></li>
...
<br><br>
	...
	<table border="0px" style="background-color:white; color: #ff8000;">
		<tr>
		<td>Transfer To:</td>
